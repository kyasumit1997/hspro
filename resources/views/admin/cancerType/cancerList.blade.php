        ...
        <div class="main">
            <div class="container-fluid">
                ...
                <div class="row">
                        ...
                        <div class="col-lg-2">
                        <a type="button" href="{{route('cancerType/create')}}" class="btn btn-primary btn-flat btn-addon m-b-10 m-l-5"><i class="ti-plus"></i>Add Cancer type</a>
                        </div>
                </div>
                    <div class="row">
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        ...
                                                        <a href="{{ url('cancerType/edit/'.$data['did'])}}"><i class="ti-pencil-alt mr-5"></i></a>

                                                        <a href="{{ url('cancerType/destroy/'.$data['did'])}}"><i class="ti-close mr-5"></i></a>

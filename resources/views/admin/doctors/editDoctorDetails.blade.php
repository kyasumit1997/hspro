                                    ...
                                    <div class="basic-form">
                                        <form action="{{route('Doctors/update')}}" method="post">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" name="name" placeholder="doctor's name" value="{{$datas['name']}}">
                                            </div>
                                            <div class="form-group">
                                                <label>Email</label>
                                            ...
                                            <select class="form-control" name="specialization">
                                                ...
                                                <?php
                                                if($data['did']==$datas['specialization'])
                                                {
                                                    $active="selected";
                                                }
                                                else
                                                {
                                                 ...
                                                 ?>
                                                 <option  value="{{$data['did']}}" {{$active}}>{{$data['cancer_type']}}</option>
                                                 @endforeach
                                             </select>
                                             @error('specilaization') <div class="alert alert-danger">
                                                         <ul>
                                                             <li>{{ $message }}</li>
                                                          </ul>
                                                     </div> 
